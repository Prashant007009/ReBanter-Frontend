    ...
    <ScreenGradient style={styles.container}>
      <KeyboardAvoidingView style={styles.keyboardView} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <View style={styles.header}>
          ...
          <VideoIcon size={21} color={colors.onDark} strokeWidth={1.8} />
          <MoreHorizontalIcon size={21} color={colors.onDark} />
        </View>
        ...
        <View style={styles.composerRow}>
          <View style={styles.cameraButton}>
            <CameraIcon size={20} color={colors.ink} strokeWidth={1.8} />
          </View>
          ...
          <Pressable style={styles.sendButton} onPress={() => send(draft)} disabled={!draft.trim() || isSending}>
            <ArrowRightIcon size={20} color={colors.ink} strokeWidth={1.9} />
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  keyboardView: { flex: 1 },
  header: { flexDirection: "row", alignItems: "center", gap: 12, paddingTop: 56, paddingHorizontal: 18, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: colors.onDarkHairline },
  headerName: { fontFamily: fonts.bodyBold, fontSize: 15, color: colors.onDark },
  ...
  bubbleTime: { fontFamily: fonts.body, fontSize: 10, color: colors.onDarkFaint, marginTop: 3, marginHorizontal: 4 },
  ...
  cameraButton: { width: 42, height: 42, borderRadius: 15, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center" },
  composerInput: {
    flex: 1,
    minHeight: 44,
    maxHeight: 120,
